...
const frames = [
  ...
  [SEEN, HIRED, UNSEEN, UNSEEN, UNSEEN, UNSEEN, UNSEEN, SEEN, SEEN],
  [SEEN, HIRED, SEEN, UNSEEN, UNSEEN, UNSEEN, UNSEEN, SEEN, SEEN],
  [SEEN, HIRED, SEEN, UNSEEN, UNSEEN, UNSEEN, UNSEEN, SEEN, HIRED],
  [SEEN, HIRED, SEEN, UNSEEN, UNSEEN, UNSEEN, SEEN, SEEN, HIRED],
  [SEEN, HIRED, SEEN, UNSEEN, UNSEEN, UNSEEN, HIRED, SEEN, HIRED],
];
