    ...
    return (
        <div className='ppt' style={{ width: 950 }}>
            ...
            <svg id='svg'
                ...
                <g style={textStyle}>
                    <text x="180" y="275" >1</text>
                    <text x="380" y="275" >2</text>
                    <text x="580" y="275" >3</text>
                    <text x="780" y="275" >4</text>
                    <text x="980" y="275" >5</text>
                </g>
                <g style={diffStyle}>
                    <text x="190" y="360" >2</text>
                    <text x="390" y="360" >1</text>
                    <text x="590" y="360" >0</text>
                    <text x="790" y="360" >1</text>
                    <text x="990" y="360" >2</text>
                </g>
                <path ref={leftPointer} id="fast-pointer" d="M205, 95 L205, 160" style={pointerStyle} />
                <path ref={rightPointer} id="slow-pointer" d="M205, 95 L205, 160" style={pointerStyle} transform='translate(-150, 0)' />
            </svg>
