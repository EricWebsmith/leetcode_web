  ...
  const navbar = showNavbar ? (
    <nav className='navbar'>
      ...
      <ul>
        ...
        <li><NavLink to="/leetcode_web/862" >862. Shortest Subarray with Sum at Least K</NavLink></li>
      </ul>
    ...
    <main>
      ...
      <div className="article">
        ...
        <Routes>
          ...
          <Route path="/leetcode_web/377" element={<Leetcode377 />}></Route>
          <Route path="/leetcode_web/659" element={<Leetcode659 />}></Route>
          <Route path="/leetcode_web/862" element={<Leetcode862 />}></Route>
